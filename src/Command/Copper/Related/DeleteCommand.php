...
class DeleteCommand extends Command
{
     ...
     * @var string
     */
    protected static $defaultName = 'app:copper:related:delete';
    ...
    {
        $this->setDescription('Delete related entities');
    ...
    {
        $data = $this->service->deleteRelatedItem($input->getArgument('id'), $input->getArgument('type'), $input->getArgument('related-id'), $input->getArgument('related-type'));
